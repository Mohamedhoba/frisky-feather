...
Future<void> _firebaseMessagingBackgroundHandler(dynamic message) async {
  ...
  printLog('Handling a background messfage ${message.messageId}');
}
...
void _setupApplication() {
  ...
  injector.get<FirebaseMessagingService>().onBackgroundMessage(
